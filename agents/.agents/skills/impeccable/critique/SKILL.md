...
- **Suggested command**: Which command could address this (from: /clarify, /animate, /distill, /optimize, /arrange, /delight, /critique, /harden, /colorize, /quieter, /bolder, /overdrive, /adapt, /extract, /polish, /normalize, /audit, /typeset, /onboard)
...
- Only recommend commands from: /clarify, /animate, /distill, /optimize, /arrange, /delight, /critique, /harden, /colorize, /quieter, /bolder, /overdrive, /adapt, /extract, /polish, /normalize, /audit, /typeset, /onboard
