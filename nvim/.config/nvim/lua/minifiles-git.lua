...
Original code from: https://gist.github.com/bassamsdata/eec0a3065152226581f8d4244cce9051
Author: @bassamsdata

Modifications made:
- Removed git status symbols, using only colors for status indication (VSCode-like)
- Kept symlink indicators (↩ symbol)
  ...
  vim.schedule(function()
    ...
    for i = 1, nlines do
      ...
      if status then
        ...
        -- Only show sign for symlinks (which have symbols)
        if symbol ~= "" then
        ...
        -- Color the filename text based on git status
