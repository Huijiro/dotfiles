...
█▄█  █▄▄█▄▄▄▄▄▄▄█▄▄▄▄▄▄▄█ █▄▄▄█ █▄▄▄█▄█   █▄█',
  ...
  footer = function()
    local languages = {
      "Rust", "Lua", "Javascript", "Typescript", "Java",
      "COBOL", "Fortran", "BASIC"
    }
    local content_creator = {
      "The Primeagen", "Theo", "The Cherno",
      "fireship", "low level", "acerola"
    }
    local messages = {
      "programming is pain.",
...
vim.keymap.set('n', '<leader>tc', ':ToggleCensor<CR>', { desc = "Toggle censoring" })
